...
```php
// /your/path/{your-attribute}/{another-attribute}
$request->attributes->get('your-attribute') // value under your-attribute
```
Fetching from `attributes` from the URL

```php
// /your/path/?{your-parameter}=some-value`
$request->query->get('your-parameter') // some-value
```
Fetching from *query* to get extra values from your URL

```
$request->request->get('your-parametr')
```
